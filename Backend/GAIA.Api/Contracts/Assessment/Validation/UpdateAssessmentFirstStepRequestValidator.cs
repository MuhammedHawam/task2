...
{
  public class UpdateAssessmentFirstStepRequestValidator : AbstractValidator<UpdateAssessmentFirstStepRequest>
  {
    public UpdateAssessmentFirstStepRequestValidator()
    {
      RuleFor(x => x.Name)
