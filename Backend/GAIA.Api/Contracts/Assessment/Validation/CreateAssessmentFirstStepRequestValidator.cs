...
{
  public class CreateAssessmentFirstStepRequestValidator : AbstractValidator<CreateAssessmentFirstStepRequest>
  {
    public CreateAssessmentFirstStepRequestValidator()
    {
      RuleFor(x => x.Name)
